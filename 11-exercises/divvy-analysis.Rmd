...
```{r}
# list member types
member_types <- first_quart_23 %>% distinct(member_casual)
member_types
```

```{r}
# number of clients for each member types
member_type_group <- first_quart_23 %>% group_by(member_casual) %>% summarise(count = n()) 
member_type_group
```

```{r}
# percent of clients for each member types
percent_type_group <- first_quart_23 %>% 
...
percent_rideable_type_group <- first_quart_23 %>% 
...
mean(first_quart_23_v2$ride_length) #straight average (total ride length / rides)
median(first_quart_23_v2$ride_length) #midpoint number in the ascending array of ride lengths
max(first_quart_23_v2$ride_length) #longest ride
min(first_quart_23_v2$ride_length) #shortest ride
...
average_ride_time_by_day_client_type <- aggregate(first_quart_23_v2$ride_length ~ first_quart_23_v2$member_casual + first_quart_23_v2$day_of_week, FUN = mean)

print(average_ride_time_by_day_client_type)
...
aggregate(first_quart_23_v2$ride_length ~ first_quart_23_v2$member_casual + first_quart_23_v2$day_of_week, FUN = mean)
...
counts <- aggregate(first_quart_23_v2$ride_length ~ first_quart_23_v2$member_casual + first_quart_23_v2$day_of_week, FUN = mean)
