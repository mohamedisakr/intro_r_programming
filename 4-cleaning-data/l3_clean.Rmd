...
<!-- # setwd("E:/Projects/intro-r/") -->

<!-- directory_path <- file.path(dirname(dirname(getwd()))) -->
<!-- directory_path -->

<!-- file_path <- file.path(directory_path, "data", "hotels.csv") -->
<!-- file_path -->

<!-- # import the data sets -->
<!-- bookings_df <- read_csv(file_path) -->
<!-- bookings_df <- as_tibble(bookings_df) -->
<!-- bookings_df -->
<!-- ``` -->
...
bookings_df <- read_csv(here("data", "hotels.csv"))
bookings_df
```
